...
<body>
    <div class="header-container" id="header-container">
        ...
        <span class="fa fa-user" style="position:absolute;top:20px;right:40px;font-size:60px;color:white"></span>
        <br><span style="position:absolute;top:100px;right:40px;font-size:20px;color:white"><?php echo "Logged in as $username"; ?></span>
