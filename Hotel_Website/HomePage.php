...
<body>
    <div class="header-container" id="header-container">
        ...
        <input type="submit" value="Log-Out" name="Log-Out" class="btn btn-logout" id="btn-logout" onclick="openLoginForm()">
        <!-- <input type="submit" value="Book-Now" name="Book-Now" class="btn booknow-btn" id="btn-booknow"> -->
        <div class="bg-modal">
