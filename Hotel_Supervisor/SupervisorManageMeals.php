...
>>>>>>> aa343214f299f5100baa68ba394797cb1643a1ab
				...
				<tr>
					<td>Price:</td>
<<<<<<< HEAD
					<td align="center"><input type="text" name="price" size="50" required></td>
=======
...
<<<<<<< HEAD
									<option value="<?php echo $row['Meal_Plan'] ?>">Staying-in</option>
									<option value="<?php echo $row['Meal_Plan'] ?>">Events</option>
=======
...
<<<<<<< HEAD
									<option value="<?php echo $row['Meal_Type'] ?>">Breakfast</option>
									<option value="<?php echo $row['Meal_Type'] ?>">Lunch</option>
									<option value="<?php echo $row['Meal_Type'] ?>">Dinner</option>
=======
								<option value="-"
										<?php
										if($row["Meal_Type"]=='-')
...
<<<<<<< HEAD
							...
							<td style="position:relative;left:180px">
								<input type="reset" class="button" name="reset" value="Reset Meal Details">
=======
...
>>>>>>> 6d32ddd7fca955a45d4ad48bf36c5ea9251ca536
					$query_run = mysqli_query($con,$query);
